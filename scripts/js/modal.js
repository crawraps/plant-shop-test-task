...
function closeModalWindow(event, modal, body) {
    if ((event === null || event === void 0 ? void 0 : event.target).classList.contains('modal-button-cancel') ||
        (event === null || event === void 0 ? void 0 : event.target).classList.contains('modal-button-close-icon') ||
        (event === null || event === void 0 ? void 0 : event.target).classList.contains('modal-overflow')) {
...
function validate(inputs) {
    ...
    if (!((number.value[0] === '8' && number.value.length === 11) ||
...
function onConfirm(event, inputs) {
    if (validate(inputs)) {
...
function createTable(entries) {
  ...
  `;
    ...
    entries.forEach((entry) => {
        if ((entry === null || entry === void 0 ? void 0 : entry.userId) === 5 && !(entry === null || entry === void 0 ? void 0 : entry.completed)) {
            table.innerHTML =
                table.innerHTML +
                    `
        <tr>
    ...
    modalWindow.style.maxWidth = '1000px';
